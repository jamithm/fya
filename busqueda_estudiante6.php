...
<?php include("includes/menu.php"); ?>
  ...
  <table width="98%" border="1" align="center" cellpadding="2" cellspacing="2">
    ...
    <tr class="brillo">
      ...
      <h3 align="center"><a target="_new" href="reporte_carta_postulacion6.php?id=<?php echo $row_Consulta_Estudiante['id']; ?>"><strong>Carta de Postulación</strong></a><strong> -  <a href="estudiantes_cartas6.php">Volver a  Estudiante</a></strong><a href="estudiantes_cartas4.php"></a></h3>
      <?php } // Show if recordset not empty ?>
<h2 style="color:#F00"><strong>
<?php if ($totalRows_Consulta_Estudiante == 0) { // Show if recordset empty ?>
  No se encontrar&oacute;n datos en la Consulta. <a href="estudiantes_cartas6.php">Volver a Estudiante</a>
