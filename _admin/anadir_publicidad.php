...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO t_slider (imagen, titulo, subtitulo, menu, link, orden, estado) VALUES (%s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "listado_publicidades.php";
  if (isset($_SERVER['QUERY_STRING'])) {
          ...
          <div id="page-inner">
            ...
            <div class="row">
                 <div class="row">
                                ...
                                <div class="form-group">
                                <label>Titulo</label>
                                <input name="titulo" class="form-control" id="titulo" placeholder="Ingrese Titulo" type="text" required="required" />
                                </div>
                                <div class="form-group">
                                <label>Sub-Titulo</label>
                                <input name="subtitulo" class="form-control" id="subtitulo" placeholder="Ingrese Sub-Titulo" type="text" required="required" />
                                </div>
                                <div class="form-group">
                                <label>Menú</label>
                                <input name="menu" class="form-control" id="menu" placeholder="Ingrese Menú" type="text" required="required" />
                                </div>
                                <div class="form-group">
                                <label>Link</label>
                                <input name="link" class="form-control" id="link" placeholder="Ingrese Link" type="text" required="required" />
                                </div>
                                <div class="form-group">
                                <label>Orden</label>
                                <input name="orden" class="form-control" id="orden" placeholder="Ingrese Orden" type="text" required="required" />
                                </div>
                                <div class="form-group">
                                <label>Estado</label>
                                <select name="estado" class="form-control" id="estado">
                                   <option value="1" <?php if (!(strcmp(0, ""))) {echo "SELECTED";} ?>>Activo</option>
                                   <option value="0" <?php if (!(strcmp(1, ""))) {echo "SELECTED";} ?>>Inactivo</option>
                                 </select>
                                  </div>
                                  <div class="form-group">
