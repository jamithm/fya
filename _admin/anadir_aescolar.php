...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO t_aescolares (denominacion, estatus) VALUES (%s, %s)",
  ...
  $insertGoTo = "listado_aescolares.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<body>
    <div id="wrapper">
      ...
      <!-- /. NAV TOP  -->
          ...
          <div id="page-inner">
            ...
            <div class="row">
                 <div class="row">
                                ...
                                <input name="denominacion" class="form-control" id="nombre" placeholder="Ingrese el Año Escolar" type="text" required="required" />
                                </div>
                                <div class="form-group">
                                <label>Estatus</label>
		...
		document.form1.denominacion.focus();
		</script>
