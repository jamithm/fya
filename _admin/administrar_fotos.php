          ...
          <div id="page-inner">
            <div class="row">
              <div class="col-md-12">
                ...
                <h2>Seleccione las Fotos que desea subir a la Galería</h2>
              </div>
            </div>
            ...
            <div class="row">
                 <div class="row">
             			...
             			<div id="inputs_file">
                                ...
                                <input name="titulo[]" class="form-control" placeholder="Ingrese Titulo de la Galería de Fotos" type="hidden" required="required" value="foto" />
                                </div>
                                 <div class="form-group">
