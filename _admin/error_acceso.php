      ...
      <!-- /. NAV TOP  -->
        ...
        <div id="page-wrapper" >
          <div id="page-inner">
            <div class="row">
              <div class="col-md-12">
                <h2>Error al Acceder a este Módulo del Sistema</h2>
              </div>
            </div>
            <div class="row">
              <h2>Disculpe, su nivel de acceso no le permite ver esta página</h2>
                 <br />
                 <br />
                 <a href="principal_admin.php" class="btn btn-info">
