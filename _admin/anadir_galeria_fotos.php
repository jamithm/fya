      ...
      <!-- /. NAV TOP  -->
        ...
        <div id="page-wrapper" >
          <div id="page-inner">
            <div class="row">
              <div class="col-md-12">
                <h2>Anadir una Galeria de Fotos</h2>
              </div>
            </div>
            ...
            <div class="row">
                 <div class="row">
                         ...
                         <form role="form" action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" autocomplete="off">
                                ...
                                <input name="titulo" class="form-control" id="titulo" placeholder="Ingrese Titulo de la Galería de Fotos" type="text" required="required" />
                                </div>
                                 <div class="form-group">
                                <label>Descripción de la Galería</label>
                                <textarea name="descripcion" cols="500" rows="5" class="form-control" id="descripcion" required="required" placeholder="Ingrese Descripción de la Galería de Fotos"></textarea>
                                </div>
