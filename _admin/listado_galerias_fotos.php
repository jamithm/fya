...
<body>
      ...
      <!-- /. NAV TOP  -->
        ...
        <div id="page-wrapper" >
          <div id="page-inner">
            <div class="row">
              <div class="col-md-12">
                <h2>Listado de Galería de Fotos</h2>
              </div>
            </div>
            <a href="anadir_galeria_fotos.php" class="btn btn-outline btn-success">
            <span class="glyphicon glyphicon-new-window"></span>
            Añadir Galería de Fotos</a>
   			<br />
             <br />
  ...
  <table class="table table-striped table-bordered table-hover" id="dataTables-example">
    ...
    <?php do { ?>
      <tr>
        <td><?php echo $row_Datos_Galerias['titulo']; ?></td>
        <td><?php echo $row_Datos_Galerias['fecha_alta']; ?></td> 
        <td>
        <a class="btn btn-sm btn-success" href="administrar_fotos.php?id=<?php echo $row_Datos_Galerias['id']; ?>">
        <span class="glyphicon glyphicon-camera"></span>
        Admininstrar</a> 
        <a class="btn btn-sm btn-primary" href="editar_galeria.php?id=<?php echo $row_Datos_Galerias['id']; ?>">
        <span class="glyphicon glyphicon-edit"></span>
        Editar</a> 
        <a class="btn btn-sm btn-danger" href="eliminar_galeria.php?id=<?php echo $row_Datos_Galerias['id']; ?>" onclick="javascript:return confirmacion();">
